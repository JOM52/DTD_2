# ta_radio_433.py - Module radio 433MHz pour GT38 (v2.4.1 - logger optionnel + RX robuste + mutex + retries)
# Version : 2.4.1 - Améliore la fiabilité UART (timeout cohérents config, lecture par ligne,
...
class Radio433:
    ...
    def __init__(self, radio_config, logger=None):
        # logger optionnel pour compat main existants
        if logger is None:
            try:
